...
Version  : 3.28.0
Release  : 6
URL      : https://download.gnome.org/sources/cheese/3.28/cheese-3.28.0.tar.xz
Source0  : https://download.gnome.org/sources/cheese/3.28/cheese-3.28.0.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1522183757
...
/usr/lib64/libcheese-gtk.so.25.1.0
/usr/lib64/libcheese.so.8
/usr/lib64/libcheese.so.8.0.10
