...
%prep
%setup -q -n cheese-3.38.0
cd %{_builddir}/cheese-3.38.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1600269234
...
cp %{_builddir}/cheese-3.38.0/COPYING %{buildroot}/usr/share/package-licenses/cheese/1f199f2dcc0341653fc919334d9c26d0d2098f93
...
/usr/lib64/libcheese-gtk.so.25.1.5
/usr/lib64/libcheese.so.8
/usr/lib64/libcheese.so.8.0.15
