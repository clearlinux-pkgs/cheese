...
export LANG=C
export SOURCE_DATE_EPOCH=1536123993
...
export SOURCE_DATE_EPOCH=1536123993
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/cheese
cp COPYING %{buildroot}/usr/share/doc/cheese/COPYING
%make_install
%find_lang cheese
