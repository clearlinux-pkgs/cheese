...
Source0  : https://download.gnome.org/sources/cheese/3.32/cheese-3.32.1.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1554742826
...
/usr/lib64/libcheese-gtk.so.25.1.3
/usr/lib64/libcheese.so.8
/usr/lib64/libcheese.so.8.0.13
